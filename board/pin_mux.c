...
board: FRDM-KL25Z
pin_labels:
- {pin_num: '77', pin_signal: PTD4/LLWU_P14/SPI1_PCS0/UART2_RX/TPM0_CH4, label: 'J1[6]/D2', identifier: TMP_ALERT}
...
- pin_list:
  ...
  - {pin_num: '77', peripheral: GPIOD, signal: 'GPIO, 4', pin_signal: PTD4/LLWU_P14/SPI1_PCS0/UART2_RX/TPM0_CH4, direction: INPUT, gpio_interrupt: no_init}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t TMP_ALERT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD4 (pin 77)  */
    GPIO_PinInit(BOARD_INITPINS_TMP_ALERT_GPIO, BOARD_INITPINS_TMP_ALERT_PIN, &TMP_ALERT_config);
    ...
    PORT_SetPinMux(BOARD_INITPINS_TMP_ALERT_PORT, BOARD_INITPINS_TMP_ALERT_PIN, kPORT_MuxAsGpio);
