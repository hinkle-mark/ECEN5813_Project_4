...
/*! @name PORTD4 (number 77), J1[6]/D2
  @{ */
#define BOARD_INITPINS_TMP_ALERT_GPIO GPIOD /*!<@brief GPIO device name: GPIOD */
#define BOARD_INITPINS_TMP_ALERT_PORT PORTD /*!<@brief PORT device name: PORTD */
#define BOARD_INITPINS_TMP_ALERT_PIN 4U     /*!<@brief PORTD pin index: 4 */
                                            /* @} */
